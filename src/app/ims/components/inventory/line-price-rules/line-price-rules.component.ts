...
export class LinePriceRulesComponent implements OnInit, OnDestroy {
  ...
  onTablePage(event: { rows?: number | null }): void {
    this.pageSizeService.applyPageEvent(TablePageSizeKeys.linePriceRules, this.rowsPerPageOptions, event, this.paging);
  }

  async ngOnInit(): Promise<void> {
    this.paging.pageSize = this.pageSizeService.initState(TablePageSizeKeys.linePriceRules, this.rowsPerPageOptions, this.paging);
