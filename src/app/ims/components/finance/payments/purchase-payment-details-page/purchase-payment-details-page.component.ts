...
@Component({
  ...
  templateUrl: './purchase-payment-details-page.component.html',
  styleUrls: ['./purchase-payment-details-page.component.css', '../payments.component.css']
})
      ...
      if (this.payment.purchaseId) {
        try {
          ...
          if (Array.isArray(purchase)) {
            this.payment.purchase = purchase[0] as Purchase;
          } else {
            this.payment.purchase = purchase as Purchase;
          }
        } catch (error) {
